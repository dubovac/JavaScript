 ...
 * @return {number}
 */
function distributeCandies(candyType) {			// var distributeCandies = function(candyType) {
	const l = new Set(candyType);
	return Math.min(Math.floor(candyType.length / 2), l.size);
}

let cT = [1, 1, 2, 2, 3, 3];
console.log(distributeCandies(cT));
